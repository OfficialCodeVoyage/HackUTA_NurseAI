...
export declare function handleEntrypoints({ entrypoints, currentEntrypoints, currentEntryIssues, manifestLoader, nextConfig, devRewrites, productionRewrites, logErrors, dev, }: {
