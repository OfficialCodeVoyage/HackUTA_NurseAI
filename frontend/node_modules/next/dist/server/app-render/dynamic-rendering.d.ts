...
export declare function createPrerenderState(isDebugDynamicAccesses: boolean | undefined): PrerenderState;
/**
...
export declare function Postpone({ reason, prerenderState, route, }: PostponeProps): never;
