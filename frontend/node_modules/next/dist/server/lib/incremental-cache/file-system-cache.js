...
class FileSystemCache {
            ...
            if (!memoryCache) {
                ...
                memoryCache = new _lrucache.default({
                    ...
                    length ({ value }) {
                        ...
                        return value.html.length + (((_JSON_stringify = JSON.stringify(value.kind === 'APP_PAGE' ? value.rscData : value.pageData)) == null ? void 0 : _JSON_stringify.length) || 0);
                    }
                });
            }
        } else if (this.debug) {
   ...
   */ loadTagsManifestSync() {
    ...
    async get(...args) {
        ...
        if (!data && process.env.NEXT_RUNTIME !== 'edge') {
            ...
            try {
                ...
                if (kind === 'fetch' && this.flushToDisk) {
                    ...
                    if (((_data_value3 = data.value) == null ? void 0 : _data_value3.kind) === 'FETCH') {
                        var _data_value4;
                    ...
                    if (isAppPath) {
                        const rscData = await this.fs.readFile(this.getFilePath(`${key}${isRoutePPREnabled ? _constants.RSC_PREFETCH_SUFFIX : _constants.RSC_SUFFIX}`, 'app'));
                        data = {
                            lastModified: mtime.getTime(),
                            value: {
                                kind: 'APP_PAGE',
                        ...
                        const pageData = JSON.parse(await this.fs.readFile(this.getFilePath(`${key}${_constants.NEXT_DATA_SUFFIX}`, 'pages'), 'utf8'));
                        data = {
                            lastModified: mtime.getTime(),
                            value: {
                                kind: 'PAGE',
        ...
        if ((data == null ? void 0 : (_data_value = data.value) == null ? void 0 : _data_value.kind) === 'APP_PAGE' || (data == null ? void 0 : (_data_value1 = data.value) == null ? void 0 : _data_value1.kind) === 'PAGE') {
    ...
    async set(...args) {
        ...
        if ((data == null ? void 0 : data.kind) === 'PAGE' || (data == null ? void 0 : data.kind) === 'APP_PAGE') {
            ...
            await this.fs.writeFile(this.getFilePath(`${key}${isAppPath ? ctx.isRoutePPREnabled ? _constants.RSC_PREFETCH_SUFFIX : _constants.RSC_SUFFIX : _constants.NEXT_DATA_SUFFIX}`, isAppPath ? 'app' : 'pages'), isAppPath ? data.rscData : JSON.stringify(data.pageData));
