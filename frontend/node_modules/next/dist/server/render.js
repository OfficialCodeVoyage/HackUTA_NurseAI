...
const _serveredge = /*#__PURE__*/ _interop_require_default(require("react-dom/server.edge"));
...
async function renderToString(element) {
    const renderStream = await _serveredge.default.renderToReadableStream(element);
