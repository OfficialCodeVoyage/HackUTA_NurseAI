...
const _withstaticgenerationstore = require("../server/async-storage/with-static-generation-store");
...
async function buildAppStaticPaths({ dir, page, distDir, configFileName, generateParams, isrFlushToDisk, cacheHandler, requestHeaders, maxMemoryCacheSize, fetchCacheKeyPrefix, ComponentMod }) {
    ...
    return (0, _withstaticgenerationstore.withStaticGenerationStore)(ComponentMod.staticGenerationAsyncStorage, {
        page,
        renderOpts: {
            incrementalCache,
