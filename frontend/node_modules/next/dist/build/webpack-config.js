...
async function getBaseWebpackConfig(dir, { buildId, encryptionKey, config, compilerType, dev = false, entrypoints, isDevFallback = false, pagesDir, reactProductionProfiling = false, rewrites, originalRewrites, originalRedirects, runWebpackSpan, appDir, middlewareMatchers, noMangling = false, jsConfig, resolvedBaseUrl, supportedBrowsers, clientRouterFilters, fetchCacheKeyPrefix, edgePreviewProps }) {
    ...
    let webpackConfig = {
        ...
        output: {
            ...
            ...config.experimental.flyingShuttle ? {
                ...
                path: isNodeServer ? _path.default.join(outputPath, `chunks-${buildId}`) : outputPath,
        ...
        plugins: [
            ...
            (isNodeServer || config.experimental.flyingShuttle && isEdgeServer) && !dev && new (require('./webpack/plugins/next-trace-entrypoints-plugin')).TraceEntryPointsPlugin({
                rootDir: dir,
                appDir: appDir,
                pagesDir: pagesDir,
    ...
    const cache = {
        ...
        version: `${__dirname}|${"15.0.0-canary.75"}|${configVars}`,
