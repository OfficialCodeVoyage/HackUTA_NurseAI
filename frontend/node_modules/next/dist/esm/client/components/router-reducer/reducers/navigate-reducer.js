        ...
        for (const flightDataPath of flightData){
            ...
            if (newTree !== null) {
                ...
                flightDataPath.length === 3) {
                    ...
                    const task = updateCacheNodeOnNavigation(currentCache, currentTree, prefetchedTree, seedData, head, mutable.onlyHashChange);
                    if (task !== null) {
                        ...
                        if (task.node !== null) {
                            ...
                            listenForDynamicRequest(task, fetchServerResponse(url, {
