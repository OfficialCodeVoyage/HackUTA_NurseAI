...
export function getServerError(error, type) {
    if (error.name === 'TurbopackInternalError') {
        ...
        const turbopackInternalError = new Error('An unexpected Turbopack error occurred. Please report the content of .next/turbopack.log to the Next.js team at https://github.com/vercel/next.js/issues/new');
