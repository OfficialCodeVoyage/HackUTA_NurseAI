...
window.console.error = function() {
    ...
    if (!isNextRouterError(error)) {
        if (process.env.NODE_ENV !== 'production') {
            const storeHydrationErrorStateFromConsoleArgs = require('./components/react-dev-overlay/internal/helpers/hydration-error-info').storeHydrationErrorStateFromConsoleArgs;
...
if (process.env.NODE_ENV === 'development') {
    const initializePrerenderIndicator = require('./components/prerender-indicator').default;
