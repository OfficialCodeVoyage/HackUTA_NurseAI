 ...
 */ export async function getPageStaticInfo(params) {
    ...
    if (/(?<!(_jsx|jsx-))runtime|preferredRegion|getStaticProps|getServerSideProps|generateStaticParams|export const|generateImageMetadata|generateSitemaps/.test(fileContent)) {
        const swcAST = await parseModule(pageFilePath, fileContent);
        const { ssg, ssr, runtime, preferredRegion, generateStaticParams, generateImageMetadata, generateSitemaps, extraProperties, directives } = checkExports(swcAST, pageFilePath);
