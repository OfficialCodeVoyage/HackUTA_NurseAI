...
import { isMetadataRoute, isStaticMetadataRoute } from '../../../lib/metadata/is-metadata-route';
        ...
        for (const filename of files){
            ...
            if (isMetadataRoute(page) && !isStaticMetadataRoute(page)) {
                ...
                // Add 2 possibilities for both single and multiple routes:
                {
                    ...
                    ;
                    const metadataBundlePath = normalizeMetadataPageToRoute(bundlePath, false) // this.normalizers.bundlePath.normalize(dummyFilename)
                    ;
