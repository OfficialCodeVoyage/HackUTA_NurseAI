 ...
 */ export class AppRouteRouteModule extends RouteModule {
   ...
   */ async execute(rawRequest, context) {
        ...
        }, ()=>withRequestStore(this.requestAsyncStorage, requestContext, (requestStore)=>withStaticGenerationStore(this.staticGenerationAsyncStorage, staticGenerationContext, (staticGenerationStore)=>{
