...
export const withStaticGenerationStore = (storage, { page, renderOpts, requestEndedState }, callback)=>{
   ...
   */ const isStaticGeneration = !renderOpts.supportsDynamicResponse && !renderOpts.isDraftMode && !renderOpts.isServerAction;
    const prerenderState = isStaticGeneration && ((_renderOpts_experimental = renderOpts.experimental) == null ? void 0 : _renderOpts_experimental.isRoutePPREnabled) ? createPrerenderState(renderOpts.isDebugDynamicAccesses) : null;
    const store = {
        isStaticGeneration,
        page,
